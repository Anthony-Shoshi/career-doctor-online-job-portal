			...
			<div class="row home-content">
				...
				<div class="col-lg-12">
					<div class="home-job-search-box mt20 mb20">
						<form class="form-inline" method="POST" action="{{ route('jobListView') }}">
							@csrf
							<div class="search_option_one">
							    <div class="form-group">
							    	<label for="exampleInputName"><span class="flaticon-search"></span></label>
							    	<input type="text" name="keyword" class="form-control h70" id="keyword" placeholder="Job Title or Keywords">
							    </div>
							</div>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3">
					<a onclick="document.getElementById('category').submit();"
				   class="icon_hvr_img_box sbbg1" style="background-image: url(images/service/1.jpg);">
						<form action="{{ route('jobListView') }}" target="_blank" id="category" method="POST" style="display: none;">
							@csrf
							<input type="hidden" name="ccategory" value="{{ $jobCategory->id }}">
						</form>
						<div class="overlay">
				...
				<div class="col-lg-6 offset-lg-3">
					<div class="pjc_all_btn text-center">
						<a class="btn btn-transparent" target="_blank" href="{{ route('jobListView') }}">Browse All Categories <span class="flaticon-right-arrow pl10"></span></a>
					</div>
				</div>
			</div>
		</div>
