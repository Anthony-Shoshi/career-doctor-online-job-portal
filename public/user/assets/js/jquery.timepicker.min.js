    ...
    !(function() {
        ...
        (e.TimePicker = function() {
            ...
            (e.TimePicker.prototype = {
                    ...
                    for (
                        -1 === t.options.timeFormat.indexOf("m") &&
                            ...
                            (t.options.interval =
                                60 *
                                Math.max(
                                    Math.round(t.options.interval / 60),
                                    1
                                )),
                            r = i
                                ? n(i)
                        ...
                        o._isValidTime(t, r) &&
                            ...
                            c.data("time-value", r)),
                            (r = new Date(
                                r.getTime() + 60 * t.options.interval * 1e3
                            ));
                    return s.children();
                },
                _isValidTime: function(e, t) {
                    ...
                    return (
                        ...
                        null !== e.options.minTime
                            ...
                            : (null === e.options.minHour &&
                                  null === e.options.minMinutes) ||
                              (i = n(e.options.minHour, e.options.minMinutes)),
                        null !== e.options.maxTime
                            ? (r = n(e.options.maxTime))
                            : (null === e.options.maxHour &&
                                  null === e.options.maxMinutes) ||
                ...
                _hasScroll: function() {
                    var e =
                        "undefined" != typeof this.ui.prop ? "prop" : "attr";
                ...
                _move: function(e, t, i) {
                    ...
                    r.length
                        ? n.activate(e, r)
                        : n.activate(e, n.viewport.children(i));
                },
                ...
                _setDefaultTime: function(t) {
                    "now" === t.options.defaultTime
                        ...
                        : t.options.defaultTime &&
                          t.options.defaultTime.getFullYear
                        ? t.setTime(n(t.options.defaultTime))
                        : t.options.defaultTime &&
                          t.setTime(
                              e.fn.timepicker.parseTime(t.options.defaultTime)
                          );
                },
                _addInputEventsHandlers: function(t) {
                    ...
                    t.element
                        ...
                        .bind("change.timepicker", function() {
                            t.closed() &&
                                t.setTime(
                                    e.fn.timepicker.parseTime(t.element.val())
                                );
                        });
                },
                select: function(t, i) {
                ...
                first: function(e) {
                    return this.instance === e
                        ? this.active &&
                              0 === this.active.prevAll(".ui-menu-item").length
                        : !1;
                },
                last: function(e) {
                    return this.instance === e
                        ? this.active &&
                              0 === this.active.nextAll(".ui-menu-item").length
                        : !1;
                },
                selected: function(e) {
                    return this.instance === e && this.active
                        ? this.active
                        : null;
                },
                open: function(t) {
                    ...
                    return (
                        (i =
                            "option" === t && arguments.length > 2
                                ? "each"
                                : -1 !==
                                  e.inArray(t, e.TimePicker.methods.chainable)
                                ? "each"
                                : "map"),
                        (n = this[i](function() {
                            var i = e(this),
            ...
            (e.fn.timepicker.formatTime = function(e, i) {
                ...
                for (u in s)
                    s.hasOwnProperty(u) &&
                        (c = c.replace(new RegExp(u, "g"), s[u]));
                return (c = c.replace(
                    new RegExp("a", "g"),
                    n > 11 ? "pm" : "am"
                ));
