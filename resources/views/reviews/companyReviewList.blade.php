                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ul class="view_edit_delete_list">
                                            <li class="list-inline-item"><a href="{{ route('viewCompanyReview', $review->id) }}" data-title="View Review" class="ajax-modal" data-toggle="tooltip" data-placement="top" title="View"><span class="flaticon-eye"></span></a></li>
                                        </ul>
                                    </td>
                                </tr>
                            @endforeach
