                    ...
                    <div class="candidate_personal_info">
                        ...
                        <div class="details">
                            ...
                            <ul class="address_list">
                                <li class="list-inline-item"><i class="flaticon-telephone" style="color: #213380;"> <a href="tel:{{ $candidateGeneralInfo->contact_phone }}">{{ $candidateGeneralInfo->contact_phone }}</a></i></li>
                            </ul>
                            <ul class="address_list">
                                <li class="list-inline-item">{{ $city->name }}</li>
                                <li class="list-inline-item">{{ $country->name }}</li>
                            </ul>
                            ...
                            <div class="candidate_resume_skill">
                                ...
                                <div class="progress-levels">
                                    ...
                                    <div class="progress-box wow" data-wow-delay="100ms" data-wow-duration="1500ms">
                                        <h5 class="box-title">{{ $skill->skill_name }}</h5>
                                        <div class="inner">
                                            <div class="bar">
                                                <div class="bar-innner"><div class="bar-fill ulockd-bgthm" data-percent="100"><div class="percent"></div></div></div>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
