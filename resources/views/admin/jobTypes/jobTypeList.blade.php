...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Job Type List</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    @foreach($jobTypes as $jobType)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('editJobType',$jobType->id) }}" class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                <a href="{{ route('deleteJobType',$jobType->id) }}" class="btn btn-danger" onclick="return confirm('Are you sure to delete this job type?');"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
